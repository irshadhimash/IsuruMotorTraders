...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Reverse Sale</li>
        </ol>
    </nav>

        <form method="POST" action="#">
            <h2>Vehicle Registration No: <?php echo $_GET['RegNo'] ?></h2>
            <h2>Confirm that you really need to reverse this transaction?  </h2>
